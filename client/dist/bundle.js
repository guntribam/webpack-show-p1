...
throw new Error("Module parse failed: C:\\desenvolvimento\\devsquad\\tech-talks\\webpack\\webpack-show-p1\\client\\app-src\\controllers\\NegociacaoController.js Unexpected character '@' (5:0)\nYou may need an appropriate loader to handle this file type.\n| import { getNegociacaoDao, Bind, getExceptionMessage, debounce, controller, bindEvent } from '../util/index.js';\n| \n| @controller('#data', '#quantidade', '#valor')\n| export class NegociacaoController {\n| ");
